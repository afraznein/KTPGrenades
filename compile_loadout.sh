#!/bin/bash
# KTPGrenades - Loadout Plugin Compiler - WSL/Linux version
...
_ktp_build_exit() {
    ...
    if [ "$rc" -ne 0 ]; then
        echo ""
        echo "========================================"
        echo "[KTP-BUILD] FAILED: KTPGrenades compile_loadout.sh exited $rc"
        echo "========================================"
...
echo "=========================================="
echo "KTPGrenades - Loadout Compiler (WSL)"
echo "=========================================="
echo
...
TEMP_BUILD="/tmp/ktpbuild_grenade"
...
echo "[KTP-BUILD] OK: KTPGrenades compile_loadout.sh"
